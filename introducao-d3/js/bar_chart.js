...
*/
var BarChart = function(container, data) {
  ...
  */
  this.x = d3.scaleBand()
    ...
    .padding(0.1); // Espaçamento entre as barras. Remova e veja o que acontece
...
BarChart.prototype.update = function(data) {
  ...
  */
  ...
  bars.enter().append("rect")
    ...
    .attr("x",(function(d) { return this.x(d.key); }).bind(this))         // ( ... ).bind(this) cuidado com parênteses
...
BarChart.prototype.sort = function(order) {
  ...
  this.svg.transition(t).selectAll('.bar')
    .delay(delay)
